package tv.floe.caduceus.hadoop.compression.lzo.create_gzip_seq_file;
 ...
 *
 */
public class CreateSeqFileJob extends Configured implements Tool
{

	   private static final Logger logger = Logger.getLogger(CreateSeqFileJob.class);

	   @Override
	   public int run(String[] args) throws Exception {

		   System.out.println( "\n\nRunning Create GZIP'd SequenceFile Example Job\n" );
		   
		   
		   JobConf conf = new JobConf( getConf(), CreateSeqFileJob.class );
		   conf.setJobName( "CreateSeqFileJob" );
		...
		//   conf.setReducerClass( ReadLZOFileReducer.class );
		   ...
		   if (bCompressOutput) {
			   ...
			   TextOutputFormat.setOutputCompressorClass(conf, org.apache.hadoop.io.compress.GzipCodec.class);
		 ...
		 static int printUsage() {
		   System.out.println("CreateSeqFileJob [-m <maps>] [-r <reduces>] <input> <output>");
		 ...
		 public static void main(String[] args) throws Exception {
			...
			int res = ToolRunner.run( new Configuration(), new CreateSeqFileJob(), args );
		    System.exit(res);
