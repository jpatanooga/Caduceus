...
//import tv.floe.caduceus.hadoop.movingaverage.MovingAverageReducer.PointCounters;

/**
 * 
 * NoShuffleSort_MovingAverageReducer
 * 
 * In this version of the reducer the points do not arrive in pre-sorted form so we have to 
 * maintain an in-memory queue to sort these points
 * 
 * 
 */
