 ...
 * YahooStockDataPoint
 * 
 * Primary function is to parse and hold the data from a line of Yahoo stock CSV data.
 * 
 * It is the main "glue code" one would need to provide to make their timeseries data source work with this example.
 * 
 * @author jpatterson
 *
 */
